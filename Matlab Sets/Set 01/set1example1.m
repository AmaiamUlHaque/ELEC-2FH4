...
Mag_R_NM = norm(R_NM); %the magnitude of R_NM 
Mag_R_PM=norm(R_PM); %the magnitude of R_PM 

COS_theta=R_PM_dot_R_NM/(Mag_R_PM *Mag_R_NM); %this is the cosine value of the angle between R_PM and R_NM  
theta=acos(COS_theta); %the angle between R_PM and R_NM